...
export class ConsoleService {
  ...
  async createPlan() {
    let plans = await this.planModel.insertMany([
      {
        "$id": "tier-0",
        "name": "Free",
        "order": 0,
      ...
      },
      {
        ...
        "addons": {
          "bandwidth": {
            ...
            "value": 100,
            "multiplier": 1000000000,
            "invoiceDesc": "Calculated for all bandwidth used across your organization."
          },
          "storage": {
            "unit": "GB",
            "price": 3,
            ...
            "value": 100,
            "multiplier": 1000000000,
            "invoiceDesc": "Calculated for all storage operations across your organization (including storage files, database data, function code, and static website hosting)"
          },
          "member": {
            "unit": "",
            "price": 0,
  ...
  async getPlans() {
    return await this.planModel.find({ isAvailable: true });
  }

  async getPlanById(id: string) {
    return await this.planModel.findOne({ id })
  }
