...
export class CreateTeamDto {
  ...
  @Matches(/^[a-zA-Z0-9][a-zA-Z0-9.-_]{0,35}$/, {
    message: 'Team ID must be 1-36 characters long, can contain a-z, A-Z, 0-9, period, hyphen, and underscore, and cannot start with a special character.',
  })
  teamId: string;
  ...
  @Length(1, 32, { each: true, message: 'Each role must be between 1 and 32 characters long.' })
  roles: string[];
}
