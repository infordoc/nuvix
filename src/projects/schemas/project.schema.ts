...
export class Project extends BaseSchema {
  ...
  @Prop({ required: false, type: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Platform' }], index: true })
  platforms: Platform[];

  @Prop({ required: false, type: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Webhook' }], index: true })
  webhooks: Webhook[];

  @Prop({ required: false, type: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Key' }], index: true })
  keys: Key[];
